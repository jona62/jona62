...
global.window = { CLOCK: {} };
['util','schedule','figure'].forEach(f => require(path.resolve(__dirname,'..','js',f+'.js')));
...
console.log('final stance width:',Math.abs(fig.feet[0].x-fig.feet[1].x).toFixed(1),'px =',(Math.abs(fig.feet[0].x-fig.feet[1].x)/H).toFixed(3),'H');
